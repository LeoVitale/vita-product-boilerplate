...
- ❌ **FORBIDDEN**: Apollo Client, React, Infrastructure details, or external libraries (except Zod).
...
- ✅ **ALLOWED**: React Hooks (shared), but no UI logic.
- ❌ **FORBIDDEN**: GraphQL queries (belongs in infrastructure/graphql), UI components.
...
- ✅ **ALLOWED**: Apollo Client, Axios, Device Storage, specific libraries.
...
- ❌ **FORBIDDEN**: GraphQL queries, business logic, direct repository access.
